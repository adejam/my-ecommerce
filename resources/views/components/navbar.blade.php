<header class="header bb_block">
    <nav class="navbar d-flex flex-row pos-relative container-fluid">
        <section class="logo-section d-flex align-center">
            ...
            <div class="navbar-content d-sm-flex d-none w-full mr-2">
                <ul class="navbar-list d-flex w-full ml-3 justify-flex-end">
                    <li class="navbar-item d-none d-sm-flex justify-center">
                        <a href="{{ url('/home') }}"
                            ...
                            <div class="nav-link-logo-cont pos-relative d-inline-block">
                                <svg class="nav-link-logo" viewBox="0 0 576 512">
                    ...
                    <li class="navbar-item dropdown-toggle-hover d-none d-lg-flex pos-relative">
                       <x-navbar-categories dropdownType="dropdown-toggle-hover" :dropdownId="'categoriesLg'"/>
                    </li>
                               
                </ul>
            </div>
            <section class="search-bar-result-cont mx-auto w-full pos-relative d-lg-block d-none">
                        ...
                        <button type="reset" class="clear-btn-div d-none align-stretch flex-row" id="close-suggestion-box"
                            ...
                            <div class="clear-btn-inner d-flex pointer align-center b-none">
                                <span class="clear-btn-span h-full d-inline-block pos-relative">
                                    <svg focusable="false" class="d-block w-full h-full" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path
                    ...
                    <button class="search-btn b-none pointer" aria-label="Search">
                        <div class="search-btn-div m-auto">
                            <span class="search-btn-span d-inline-block pos-relative">
                                <svg focusable="false" class="d-block" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24">
                                    <path
                ...
                <section class="suggestion-section d-none pos-absolute w-full ta-left" aria-label="suggestion section"
            ...
            <div class="navbar-content d-flex ml-auto w-full mr-2">
                <ul class="navbar-list ml-3 d-flex w-full justify-flex-end">
                    <li class="navbar-item d-lg-none d-flex justify-center">
                        <button type="button" data-target="searchbar-modal"
                            class="open-modal-button d-flex align-center pointer flex-column justify-center pos-relative tt-capitalize navbar-btn">
                        ...
                        <x-modal modalId="searchbar-modal" :modalTitle="''">
                            <section class="search-bar-result-cont mx-auto w-full pos-relative">
                                <form method="GET" action="#" class="search-bar-form d-flex w-full"
                                    id="search-bar-section-sm">
                                    @csrf
                                    <div class="search-input-div d-flex flex-1">
                                        <div class="search-div d-flex flex-1">
                                            <input type="search" class="search-input b-none d-flex" name="search"
                                                id="search-sm" data-parent_to_target="search-bar-section-sm"
                                                data-box="suggestion-section-sm"
                                                data-close_searchbox="close-suggestion-box-sm" />
                                        </div>
                                        <button type="reset" class="clear-btn-div d-none align-stretch flex-row"
                                            id="close-suggestion-box-sm" data-parent_to_target="search-bar-section-sm"
                                            data-box="suggestion-section-sm">
                                            <div class="clear-btn-inner d-flex pointer align-center b-none">
                                                <span class="clear-btn-span h-full d-inline-block pos-relative">
                                                    <svg focusable="false" class="d-block w-full h-full"
                                ...
                                <section class="suggestion-section d-none w-full ta-left" aria-label="suggestion section"
                                    id="suggestion-section-sm">
                                    <div class="suggestion-div d-flex flex-column overflow-hidden">
                                        <div class="suggestion-divider"></div>
                                        <ul class="suggestion-list flex-auto">
                                            <li class="suggestion-list-item d-flex align-center">
                    ...
                    <li class="navbar-item d-none d-sm-flex justify-center">
                        <a href="{{ url('/profile') }}"
                            ...
                            <div class="nav-link-logo-cont pos-relative d-flex">
                                <span
                                    class="badge-cont ta-center bg-danger d-flex align-center justify-center pos-absolute">
                    ...
                    <li class="navbar-item d-none d-sm-flex justify-center">
                        <a href="{{ url('/profile') }}"
                            ...
                            <div class="nav-link-logo-cont pos-relative d-flex">
                                ...
                                <svg viewBox="0 0 512 512" class="nav-link-logo">
                                    <path fill="currentColor"
                    ...
                    <li class="navbar-item d-lg-none d-flex justify-sm-center justify-flex-end">
                        <button type="button" id="toggle-mobile-nav" data-target="mobile-nav"
                            class="d-flex align-center pointer flex-column justify-center pos-relative tt-capitalize navbar-btn">
                            <div class="caret hamburger m-auto d-flex flex-column justify-space-between" id="hamburger">
                                <div class="line1 w-full bg-secondary"></div>
                                <div class="line2 w-full bg-secondary"></div>
                                <div class="line3 w-full bg-secondary"></div>
                            </div>
                        </button>
                    </li>
                </ul>
                <div class="mobile-nav d-block bg-white d-lg-none" id="mobile-nav">
                    <ul class="d-lg-none navbar-list d-flex flex-column w-full mobile-nav-list">
                        <li class="mobile-nav-item dropdown-toggle-click pos-relative m-2 d-lg-none" id="categoriesSm" data-toggle="dropdown-categoriesSm" data-classname="d-none" data-isparentchild="yes">
                            <x-navbar-categories dropdownType="dropdown-toggle-click" :dropdownId="'categoriesSm'"/>
                        </li>
                        <li class="mobile-nav-item pos-relative p-1 m-2 ">
                            <a href="{{ url('/profile') }}"
                                class="{{ request()->routeIs('profile') ? 'navbar-link-active' : 'navbar-link-inactive' }} d-flex align-center pointer flex-column justify-center pos-relative tt-capitalize navbar-link  ">
                                <div class="nav-link-logo-cont pos-relative d-flex">
                                    <span
                                    ...
                                    <span class="d-block d-lg-none ml-4">Favorites</span>
                                </div>
                            </a>
                        </li>
                        <li>ghjk</li>
