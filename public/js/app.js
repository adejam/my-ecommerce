...
/* harmony import */ var _dom_logics_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dom-logics/modal */ "./resources/js/dom-logics/modal.js");
/* harmony import */ var _dom_logics_toggleMobileNav__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dom-logics/toggleMobileNav */ "./resources/js/dom-logics/toggleMobileNav.js");
/* harmony import */ var _dom_logics_toggleElement__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dom-logics/toggleElement */ "./resources/js/dom-logics/toggleElement.js");
...
var toggleNavBtn = document.querySelector('#toggle-mobile-nav');
var closeModalButton = document.querySelectorAll('.close-modal-button');
var dropdownToggleClick = document.querySelectorAll('.dropdown-toggle-click');
var MegaDropdownToggleClick = document.querySelectorAll('.mega-dropdown-toggle-click');

if (dropdownToggleClick) {
  dropdownToggleClick.forEach(function (dropdownToggle) {
    dropdownToggle.addEventListener('click', _dom_logics_toggleElement__WEBPACK_IMPORTED_MODULE_6__.default);
  });
}
...
if (closeModalButton) {
  closeModalButton.forEach(function (btn) {
    btn.addEventListener('click', _dom_logics_modal__WEBPACK_IMPORTED_MODULE_4__.closeModal);
  });
}

if (toggleNavBtn) {
  toggleNavBtn.addEventListener('click', _dom_logics_toggleMobileNav__WEBPACK_IMPORTED_MODULE_5__.default);
}

window.addEventListener('click', _dom_logics_modal__WEBPACK_IMPORTED_MODULE_4__.windowClickCloseModal);
...
if (searchInputSm) {
  searchInputSm.addEventListener('keyup', _dom_logics_showSearchResults__WEBPACK_IMPORTED_MODULE_2__.default);
}
...
if (closeSuggestionBoxSm) {
  closeSuggestionBoxSm.addEventListener('click', _dom_logics_closeSuggestionBoxFunc__WEBPACK_IMPORTED_MODULE_3__.default);
}
...
/***/ "./resources/js/dom-logics/toggleElement.js":
/*!**************************************************!*\
  !*** ./resources/js/dom-logics/toggleElement.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var toggleElement = function toggleElement(e) {
  var currentTarget = e.currentTarget;
  e.stopPropagation();
  var _currentTarget$datase = currentTarget.dataset,
      toggle = _currentTarget$datase.toggle,
      classname = _currentTarget$datase.classname,
      isparentchild = _currentTarget$datase.isparentchild;
  var toggleId = toggle;
  var targetElement;

  if (isparentchild === 'yes') {
    targetElement = currentTarget.querySelector(".".concat(currentTarget.classList.item(0), " > #").concat(toggleId));
  } else {
    targetElement = document.querySelector("#".concat(toggleId));
  }

  targetElement.classList.toggle(classname);
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (toggleElement);

/***/ }),

/***/ "./resources/js/dom-logics/toggleMobileNav.js":
/*!****************************************************!*\
  !*** ./resources/js/dom-logics/toggleMobileNav.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var toggleMobileNav = function toggleMobileNav(_ref) {
  var currentTarget = _ref.currentTarget;
  var target = currentTarget.dataset.target;
  var targetId = target;
  var mobileNav = document.querySelector("#".concat(targetId));
  var navLinksList = document.querySelectorAll('.mobile-nav-item');
  var hamburger = document.querySelector('#hamburger');
  mobileNav.classList.toggle('mobile-nav-active');
  hamburger.classList.toggle('hamburgerToggle');
  navLinksList.forEach(function (list, index) {
    if (list.style.animation) {
      list.style.animation = '';
    } else {
      list.style.animation = "mobileNavLinksFade 0.5s ease forwards ".concat(index / 7 + 0.5, "s");
    }
  });
};
