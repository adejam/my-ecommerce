/******/ (() => {
  ...
  \*****************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */ var _dom_logics_placeholderLabel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./dom-logics/placeholderLabel */ './resources/js/dom-logics/placeholderLabel.js',
        );
        /* harmony import */ var _dom_logics_placeholderLabel__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(
          _dom_logics_placeholderLabel__WEBPACK_IMPORTED_MODULE_0__,
        );
        /* harmony import */ var _dom_logics_createOptionsFromGivenValue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./dom-logics/createOptionsFromGivenValue */ './resources/js/dom-logics/createOptionsFromGivenValue.js',
        );
        /* harmony import */ var _dom_logics_showSearchResults__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./dom-logics/showSearchResults */ './resources/js/dom-logics/showSearchResults.js',
        );
        /* harmony import */ var _dom_logics_closeSuggestionBoxFunc__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./dom-logics/closeSuggestionBoxFunc */ './resources/js/dom-logics/closeSuggestionBoxFunc.js',
        );
        /* harmony import */ var _dom_logics_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./dom-logics/modal */ './resources/js/dom-logics/modal.js',
        );
        __webpack_require__(/*! ./bootstrap */ './resources/js/bootstrap.js');

        var stateValue = document.querySelector('#state');
        var searchInput = document.querySelector('#search');
        var searchInputSm = document.querySelector('#search-sm');
        var closeSuggestionBox = document.querySelector('#close-suggestion-box');
        var closeSuggestionBoxSm = document.querySelector('#close-suggestion-box-sm');
        ...
        if (openModalButton) {
          openModalButton.forEach(function (btn) {
            btn.addEventListener('click', _dom_logics_modal__WEBPACK_IMPORTED_MODULE_4__.openModal);
          });
        }
        ...
        if (closeModalButton) {
          closeModalButton.forEach(function (btn) {
            btn.addEventListener(
              'click',
              _dom_logics_modal__WEBPACK_IMPORTED_MODULE_4__.closeModal,
            );
          });
        }
        ...
        window.addEventListener(
          'click',
          _dom_logics_modal__WEBPACK_IMPORTED_MODULE_4__.windowClickCloseModal,
        );

        if (stateValue) {
          stateValue.addEventListener(
            'change',
            _dom_logics_createOptionsFromGivenValue__WEBPACK_IMPORTED_MODULE_1__.default,
          );
        }
        ...
        if (searchInput) {
          searchInput.addEventListener(
            'keyup',
            _dom_logics_showSearchResults__WEBPACK_IMPORTED_MODULE_2__.default,
          );
        }

        if (searchInputSm) {
          searchInputSm.addEventListener(
            'keyup',
            _dom_logics_showSearchResults__WEBPACK_IMPORTED_MODULE_2__.default,
          );
        }
        ...
        if (closeSuggestionBox) {
          closeSuggestionBox.addEventListener(
            'click',
            _dom_logics_closeSuggestionBoxFunc__WEBPACK_IMPORTED_MODULE_3__.default,
          );
        }

        if (closeSuggestionBoxSm) {
          closeSuggestionBoxSm.addEventListener(
            'click',
            _dom_logics_closeSuggestionBoxFunc__WEBPACK_IMPORTED_MODULE_3__.default,
          );
        }
  ...
  \****************************************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */ var _arrays_selectInputObjectAndArrays__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ../arrays/selectInputObjectAndArrays */ './resources/js/arrays/selectInputObjectAndArrays.js',
        );
        /* harmony import */ var _removeAllChildrenElements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./removeAllChildrenElements */ './resources/js/dom-logics/removeAllChildrenElements.js',
        );
        ...
        var createOptionsFromGivenValue = function createOptionsFromGivenValue(e) {
          ...
          if (value) {
            var values =
              _arrays_selectInputObjectAndArrays__WEBPACK_IMPORTED_MODULE_0__.default[
                dataset.object_to_check
              ][value];
            (0, _removeAllChildrenElements__WEBPACK_IMPORTED_MODULE_1__.default)(
              fieldTocreateOptionsFor,
            );
    ...
    /***/ './resources/js/dom-logics/modal.js':
      /*!******************************************!*\
  !*** ./resources/js/dom-logics/modal.js ***!
  \******************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ windowClickCloseModal: () => /* binding */ windowClickCloseModal,
          /* harmony export */
        });
  ...
  /******/ /******/ (() => {
    ...
    /******/ /******/ var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
      /******/ var [chunkIds, moreModules, runtime, executeModules] = data; // add "moreModules" to the modules object, // then flag all "chunkIds" as loaded and fire callback
      /******/ /******/ /******/ var moduleId,
        chunkId,
        i = 0,
        resolves = [];
