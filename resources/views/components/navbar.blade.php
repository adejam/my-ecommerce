    ...
    <nav class="navbar d-flex flex-row pos-relative container-fluid">
        ...
        <div class="navbar-content d-sm-flex d-none w-full mr-2">
            <ul class="navbar-list d-flex w-full justify-flex-end">
                ...
                <li class="navbar-item d-none d-sm-flex justify-center">
                    <button type="button"
                        class="d-flex category-nav align-center pointer flex-column justify-center pos-relative tt-capitalize navbar-btn">
                        <div class="nav-link-logo-cont pos-relative d-flex align-center">
                            <svg class="nav-link-logo mr-1" viewBox="0 0 24 24">
                                <path fill="currentColor"
        ...
        <section class="search-bar-result-cont mlr-auto w-full pos-relative d-lg-block d-none">
            ...
            <ul class="navbar-list d-flex w-full justify-flex-end">
                <li class="navbar-item d-lg-none d-flex justify-center">
                    ...
                    <x-modal modalId="searchbar-modal" :modalTitle="''">
                        <section class="search-bar-result-cont mlr-auto w-full pos-relative">
                            <form method="GET" action="#" class="search-bar-form d-flex w-full" id="search-bar-section-sm">
                                @csrf
                                <div class="search-input-div d-flex flex-1">
                                    <div class="search-div d-flex flex-1">
                                        <input type="search" class="search-input b-none d-flex" name="search" id="search-sm"
                                            data-parent_to_target="search-bar-section-sm" data-box="suggestion-section-sm"
                                            data-close_searchbox="close-suggestion-box-sm" />
                                    </div>
                                    <button type="reset" class="clear-btn-div d-none align-stretch flex-row" id="close-suggestion-box-sm"
                                        data-parent_to_target="search-bar-section-sm" data-box="suggestion-section-sm">
                                        <div class="clear-btn-inner d-flex pointer align-center b-none">
                                            <span class="clear-btn-span h-full d-inline-block pos-relative">
                                                <svg focusable="false" class="d-block w-full h-full" xmlns="http://www.w3.org/2000/svg"
